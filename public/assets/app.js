...
var isVhListenerSet = false;

function setVhUnit() {
  var vh = window.innerHeight * 0.01;
  document.documentElement.style.setProperty('--vh', "".concat(vh.toFixed(2), "px"));
  isVhListenerSet = true;
}

window.addEventListener('resize', setVhUnit);
setVhUnit();
},{"../sass/index.scss":"../sass/index.scss"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
